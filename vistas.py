            ...
            while menu_var == 0:
                if opcion_ingresada in opciones_menu.keys():
                    if opcion_ingresada == 1:
                        Operaciones().ingresar_libro(email, self.cursor, self.conexion)

                    elif opcion_ingresada == 2:
                        Operaciones().eliminar_libro(self.cursor, self.conexion)

                    elif opcion_ingresada == 3:
                        Operaciones().modificar_libro(email, self.cursor, self.conexion)

                    elif opcion_ingresada == 4:
                        Operaciones().consultar_libro(self.cursor)
