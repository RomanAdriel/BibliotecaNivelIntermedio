...
class Operaciones:
    ...
    def modificar_libro(self, email, cursor, conexion):
        continuar = "s"
        ...
        while continuar == "s":
            ...
            try:
                ...
                print(mensajes["SEPARADOR_MENU"],
                      "Se ha encontrado un error en la ejecución de la query: " + str(error),
    ...
    def eliminar_libro(self, cursor, conexion):
        continuar = "s"
    ...
    def ingresar_libro(self, email, cursor, conexion):
        continuar = "s"
    ...
    def consultar_libro(self, cursor):
        continuar = "s"
        ...
        while continuar == "s":
            ...
            try:
                cursor.execute(queries["CONSULTAR_LIBRO"].format(columna=datos[0], valor=datos[1]))
